(function(){'use strict';(function() {
  var __antiedBundle = function() {
    ...
    __export(antied_exports, {
      default: function() {
        return antied_default;
      },
      isEnabled: function() {
        return isEnabled;
      },
      regexEscaper: function() {
        return regexEscaper;
      },
      stripVersions: function() {
        return stripVersions;
      },
      vendettaUiAssets: function() {
        return vendettaUiAssets;
      }
    });
    ...
    vendetta.metro.common.i18n;
    var url = vendetta.metro.common.url;
    vendetta.metro.common.clipboard;
    ...
    var tsStyle = function() {
      const s = storage.switches?.timestampStyle;
      return s && "tTdDfFR".includes(s) ? s : "R";
    };
    var flux_dispatch_default = function(deletedMessageArray2) {
      return before("dispatch", FluxDispatcher, function(args) {
        if (isEnabled) {
          try {
            const ev = args[0];
            if (!ev || !ev.type)
            ...
            if (ev.type === "MESSAGE_DELETE") {
              ...
              deletedMessageArray2.set(ev.id, {
                message: args,
                stage: 1
              });
              return args;
...
`;
    ...
    var update_rows_default = function(deletedMessagesArray) {
      ...
      return before("updateRows", rowsController, function(args) {
        if (isEnabled) {
          ...
          if (!hasDeleted)
            return;
          const { colors: { textColor, backgroundColor, backgroundColorAlpha, gutterColor, gutterColorAlpha }, switches: { useBackgroundColor, minimalistic, removeDismissButton, overrideIndicator, useIndicatorForDeleted, useEphemeralForDeleted }, inputs: { deletedMessageBuffer, customIndicator } } = storage;
        ...
        if (isEnabled) {
          try {
            ...
            component.then(function(instance) {
              const unpatch2 = after("default", instance, function(_, comp) {
                try {
                  ...
                  const buttons = findInReactTree(comp, function(c) {
                  ...
                  if (checkIfBufferExist) {
                    ...
                    buttons.splice(targetPos, 0, /* @__PURE__ */ React2.createElement(ActionSheetRow, {
                      label: "\u6E05\u9664\u7F16\u8F91\u5386\u53F2",
                      subLabel: `\u7531 ${stripVersions(plugin?.manifest?.name) || "ANTIED"} \u6DFB\u52A0`,
                      icon: /* @__PURE__ */ React2.createElement(ActionSheetRow.Icon, {
                  ...
                  if (storage.debug)
                    console.log(`[ANTIED ActionSheet]`, "useEphemeralForDeleted", !storage?.switches?.useEphemeralForDeleted, "msgExist?", Boolean(deletedMessageArray2.has(message.id)));
    ...
    var SC = Object.keys(semanticColors).map(function(x) {
      return `semanticColors.${x}`;
    });
    var RC = Object.keys(rawColors).map(function(x) {
      return `rawColors.${x}`;
    });
    var semRaw = [
      ...SC,
    ...
    function SemRawComponent() {
      useProxy(storage);
      return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(ScrollView, null, /* @__PURE__ */ React.createElement(FormRow2, {
        label: "\u9009\u62E9\u989C\u8272"
        ...
        return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(SelectRow, {
          ...
          onPress: function() {
            return storage.colors.semRawColorPrefix = NAME;
          }
    ...
    function ColorPickComponent({ styles: styles5 }) {
      ...
      const [BGAlpha, setBGAlpha] = React2.useState(clamp(hexAlphaToPercent(storage?.colors?.backgroundColorAlpha) ?? 100, 0, 100));
      const [gutterAlpha, setGutterAlpha] = React2.useState(clamp(hexAlphaToPercent(storage?.colors?.gutterColorAlpha) ?? 100, 0, 100));
      ...
      return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(View, {
        style: [
          styles5.subText
        ]
      }, storage?.switches?.useSemRawColors && /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(FormRow3, {
        label: "\u8BED\u4E49\u4E0E\u539F\u59CB\u989C\u8272",
        subLabel: "\u542F\u7528\u201C\u4F7F\u7528\u8BED\u4E49/\u539F\u59CB\u989C\u8272\u201D\u540E\uFF0C\u53EF\u5728\u6B64\u9009\u62E9\u989C\u8272\u3002",
        leading: /* @__PURE__ */ React2.createElement(FormRow3.Icon, {
          source: getAssetIDByName("ic_audit_log_24px")
        }),
        ...
        onPress: function() {
          return navigation.push("VendettaCustomPage", {
            title: "\u8BED\u4E49\u4E0E\u539F\u59CB\u989C\u8272",
            render: function() {
              return /* @__PURE__ */ React2.createElement(SemRawComponent, null);
            }
          });
        }
        ...
        return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(FormRow3, {
          label: obj?.label,
          subLabel: obj?.subLabel || "\u70B9\u51FB\u66F4\u65B0",
          onPress: whenPressed,
          trailing: /* @__PURE__ */ React2.createElement(TouchableOpacity, {
            onPress: whenPressed
            ...
            style: {
              ...
              height: 32,
              borderRadius: 10,
              backgroundColor: storage?.colors[obj.id] || customizeableColors.find(function(x) {
                return x?.id == obj?.id;
              })?.defaultColor || "#000"
            }
          }))
      ...
      }, /* @__PURE__ */ React2.createElement(FormRow3, {
        style: {
        ...
        subLabel: `\u70B9\u51FB\u5207\u6362\u6A21\u5F0F`,
        trailing: /* @__PURE__ */ React2.createElement(FormSwitch, {
          value: storage?.switches?.darkMode ?? true,
          onValueChange: function(value) {
            return storage.switches.darkMode = value;
          }
        })
      }), /* @__PURE__ */ React2.createElement(View, {
        style: [
      ...
      }, " \u666E\u901A\u793A\u4F8B\u6D88\u606F "), /* @__PURE__ */ React2.createElement(Text, {
        style: {
          fontSize: 20,
          color: storage.colors.textColor || "#000000"
        }
      }, " \u5DF2\u5220\u9664\u793A\u4F8B\u6D88\u606F "))), /* @__PURE__ */ React2.createElement(FormRow3, {
        label: "\u70B9\u51FB\u5207\u6362\u8F93\u5165\u65B9\u5F0F",
        subLabel: "\u5728\u6ED1\u5757\u548C\u6570\u503C\u8F93\u5165\u4E4B\u95F4\u5207\u6362",
        onPress: function() {
          setUseText(!useText);
        }
      }), useText ? /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(FormInput, {
      ...
      })) : /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(FormSliderRow, {
      ...
      })), /* @__PURE__ */ React2.createElement(FormDivider2, null), useText ? /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(FormInput, {
    ...
    function CustomizationComponent({ styles: styles5 }) {
      useProxy(storage);
      return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(View2, {
        style: [
          styles5.subText
        ]
      }, storage?.switches.minimalistic && /* @__PURE__ */ React.createElement(HelpMessage, {
        messageType: 0
        ...
        return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(FormRow4, {
          ...
          leading: obj?.icon && /* @__PURE__ */ React.createElement(FormIcon2, {
            style: {
              opacity: 1
            },
            source: getAssetIDByName(obj?.icon)
          }),
          trailing: "id" in obj ? /* @__PURE__ */ React.createElement(FormSwitch2, {
            value: storage?.switches[obj?.id] ?? obj?.default,
            onValueChange: function(value) {
              return storage.switches[obj?.id] = value;
            }
          }) : void 0
    ...
    function addIcon(i) {
      return /* @__PURE__ */ React2.createElement(FormIcon3, {
        style: {
          opacity: 1
        },
        source: getAssetIDByName(i)
      });
    }
    ...
    function AddUser({ index }) {
      ...
      const onPressIn = function() {
        return Animated3.spring(animatedButtonScale, {
          toValue: 1.1,
          duration: 10,
      ...
      const navigation = NavigationNative.useNavigation();
      useIsFocused();
      return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(ScrollView4, null, /* @__PURE__ */ React2.createElement(View3, {
        style: [
          styles.basicPad,
          styles.sub
        ]
      }, /* @__PURE__ */ React2.createElement(FormSection2, {
        title: "\u7528\u6237\u8BBE\u7F6E",
        style: [
          styles.header
        ]
      }, /* @__PURE__ */ React2.createElement(FormRow5, {
        label: "\u67E5\u627E\u7528\u6237 ID \u6216\u7528\u6237\u540D",
      ...
      }), /* @__PURE__ */ React2.createElement(FormInput2, {
        title: "\u7528\u6237\u540D\uFF5C\u533A\u5206\u5927\u5C0F\u5199",
        placeholder: "\u672A\u586B\u5199",
        ...
        trailing: /* @__PURE__ */ React2.createElement(FormSwitch3, {
          value: object?.isWebhook || false,
          onValueChange: function(value) {
            return object.isWebhook = value;
          }
        })
      })), user && /* @__PURE__ */ React2.createElement(View3, {
        style: [
          styles.container,
          {
            paddingBottom: 10
      ...
      }, /* @__PURE__ */ React2.createElement(TouchableOpacity3, {
        onPress: function() {
        ...
        onPressIn,
        onPressOut
      }, /* @__PURE__ */ React2.createElement(Animated3.View, {
        style: animatedScaleStyle
      }, /* @__PURE__ */ React2.createElement(Image3, {
        source: {
      ...
      }))), /* @__PURE__ */ React2.createElement(View3, {
      ...
      }, /* @__PURE__ */ React2.createElement(Text3, {
        style: [
          styles.mainText,
          styles.header
        ]
      }, user?.username || object?.username || "\u65E0\u540D\u79F0"))), /* @__PURE__ */ React2.createElement(FormDivider4, null)), /* @__PURE__ */ React2.createElement(FormRow5, {
        label: /* @__PURE__ */ React2.createElement(FormLabel2, {
          text: "\u4ECE\u5FFD\u7565\u5217\u8868\u79FB\u9664\u7528\u6237",
          style: {
    ...
    function addIcon2(i, dr) {
      return /* @__PURE__ */ React2.createElement(FormIcon4, {
        style: {
          opacity: 1
        },
        source: i 
    ...
    function ListUsers() {
      ...
      const addNewUser = function() {
        if (newUser) {
          ...
          navigation.push("VendettaCustomPage", {
            title: `\u6DFB\u52A0\u7528\u6237\u5230\u5FFD\u7565\u5217\u8868`,
            render: function() {
              return /* @__PURE__ */ React2.createElement(AddUser, {
      ...
      return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(ScrollView5, {
        style: {
          flex: 1
        }
      }, /* @__PURE__ */ React2.createElement(FormSection3, {
        style: [
          styles2.header,
          styles2.basicPad
        ]
      }, /* @__PURE__ */ React2.createElement(View4, {
        style: [
          styles2.header,
          styles2.sub
        ]
      }, users.length > 0 && /* @__PURE__ */ React2.createElement(FormRow6, {
        label: "\u6E05\u7A7A\u5217\u8868",
        trailing: addIcon2(Trash),
        onPress: function() {
          if (users.length !== 0) {
        ...
        return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(FormRow6, {
      ...
      }), /* @__PURE__ */ React2.createElement(FormRow6, {
        label: /* @__PURE__ */ React2.createElement(TextInput4, {
          value: newUser,
        ...
        trailing: /* @__PURE__ */ React2.createElement(TouchableOpacity4, {
          onPress: addNewUser
        }, addIcon2(Add2))
      })))));
    }
    ...
    function IgnoreListComponent() {
      ...
      return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(FormRow7, {
        label: "\u6DFB\u52A0\u7528\u6237\u5230\u5217\u8868",
        subLabel: "\u63D2\u4EF6\u5C06\u5FFD\u7565\u8FD9\u4E9B\u7528\u6237",
        leading: /* @__PURE__ */ React.createElement(FormIcon5, {
          style: {
            opacity: 1
          },
          source: getAssetIDByName("ic_members")
        }),
        onPress: listIgnore,
        trailing: /* @__PURE__ */ React.createElement(TouchableOpacity5, {
          onPress: listIgnore
        }, /* @__PURE__ */ React.createElement(FormIcon5, {
          style: {
            opacity: 1
          },
    ...
    function NerdComponent({ stx }) {
      ...
      return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(HelpMessage2, {
        messageType: 0
      }, "\u66F4\u6539\u63D2\u4EF6\u7F51\u5740\u53EF\u80FD\u4F1A\u5C06\u540E\u7EED\u66F4\u65B0\u91CD\u5B9A\u5411\u5230\u65B0\u6765\u6E90\uFF0C\u6216\u5BFC\u81F4\u65E0\u6CD5\u66F4\u65B0\u3002"), /* @__PURE__ */ React2.createElement(FormInput5, {
        title: "\u66F4\u6539\u63D2\u4EF6\u7F51\u5740",
      ...
      }), /* @__PURE__ */ React2.createElement(FormDivider7, null), /* @__PURE__ */ React2.createElement(FormRow8, {
        label: "\u6062\u590D\u539F\u59CB\u7F51\u5740",
        ...
        trailing: /* @__PURE__ */ React2.createElement(FormSwitch6, {
          value: storage.debug,
          onValueChange: function(value) {
            storage.debug = value;
          }
    ...
    function PatchesComponent({ styles: styles5 }) {
      useProxy(storage);
      return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(View6, {
        style: [
          styles5.subText
        ]
      }, togglePatch?.map(function(obj, index) {
        return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(FormRow9, {
          label: obj?.label,
          subLabel: obj?.subLabel,
          leading: obj?.icon && /* @__PURE__ */ React.createElement(FormIcon6, {
            style: {
              opacity: 1
            },
            source: getAssetIDByName(obj?.icon)
          }),
          trailing: "id" in obj ? /* @__PURE__ */ React.createElement(FormSwitch7, {
            value: storage?.switches[obj?.id] ?? obj?.default,
            onValueChange: function(value) {
              return storage.switches[obj?.id] = value;
            }
    ...
    function TextComponent({ styles: styles5 }) {
      useProxy(storage);
      return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(View7, {
        style: [
          styles5.subText
        ]
      }, customizedableTexts?.map(function(obj, index) {
        return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(FormInput7, {
          title: obj?.title,
          keyboardType: obj?.type,
          placeholder: obj?.placeholder?.toString(),
          value: storage?.inputs[obj.id] ?? obj?.placeholder,
          onChange: function(val) {
            return storage.inputs[obj.id] = val.toString();
          }
        }), index !== customizedableTexts.length - 1 && /* @__PURE__ */ React.createElement(FormDivider9, null));
      }), /* @__PURE__ */ React.createElement(FormInput7, {
        title: "\u81EA\u5B9A\u4E49\u63D2\u4EF6\u540D\u79F0",
        keyboardType: "default",
      ...
      }), /* @__PURE__ */ React.createElement(FormDivider9, null), /* @__PURE__ */ React.createElement(FormRow10, {
        label: `\u5F53\u524D\u4F7F\u7528\u56FE\u6807 - ${storage?.misc?.editHistoryIcon || "ic_edit_24px"}`,
        subLabel: "\u201C\u5386\u53F2\u8BB0\u5F55\u5DF2\u6E05\u9664\u201D\u63D0\u793A\u4F7F\u7528\u7684\u56FE\u6807",
        trailing: /* @__PURE__ */ React.createElement(FormIcon7, {
          style: {
            opacity: 1
          },
          source: getAssetIDByName(storage?.misc?.editHistoryIcon)
        })
      }), /* @__PURE__ */ React.createElement(FormDivider9, null), /* @__PURE__ */ React.createElement(FormInput7, {
        title: "\u56FE\u6807\u540D\u79F0",
        keyboardType: "default",
        placeholder: "ic_edit_24px",
        value: storage?.misc?.editHistoryIcon || "ic_edit_24px",
        onChange: function(val) {
          return storage.misc.editHistoryIcon = val.toString();
        }
      })));
    }
    var timestamps = [
    ...
    function TimestampComponent() {
      useProxy(storage);
      return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(FormRow11, {
        label: "\u65F6\u95F4\u6233\u6837\u5F0F"
        ...
        return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(SelectRow, {
          ...
          onPress: function() {
            return storage.switches.timestampStyle = type;
          }
        }), i !== timestamps.length - 1 && /* @__PURE__ */ React.createElement(FormDivider10, null));
      }), /* @__PURE__ */ React.createElement(FormDivider10, null), /* @__PURE__ */ React.createElement(FormRow11, {
        label: "\u65F6\u95F4\u6233\u4F4D\u7F6E"
        ...
        return /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(SelectRow, {
          ...
          onPress: function() {
            return storage.misc.timestampPos = key;
          }
    ...
    function CreditsPage() {
      ...
      const open = function(uri) {
        return url.openURL(uri).catch(function() {
        });
      };
      const getUser2 = function(id2) {
        return UserStore2?.getUser(id2) || Object.values(UserStore2?.getUsers()).find(function(u) {
          return u.id === id2;
        }) || null;
      };
      const getUserPng = function(id2) {
        const u = getUser2(id2);
        return u?.getAvatarURL?.()?.replace("webp", "png") || null;
      };
      const box = function(u) {
        return /* @__PURE__ */ React2.createElement(Image7, {
          source: {
            uri: u
          },
          style: {
      ...
      return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(ScrollView9, null, /* @__PURE__ */ React2.createElement(FormSection7, {
        title: "\u5F00\u53D1\u8005"
      }, /* @__PURE__ */ React2.createElement(FormRow12, {
        label: me.name,
        subLabel: me.role,
        leading: box(getUserPng(me?.uuid))
      })), /* @__PURE__ */ React2.createElement(FormSection7, {
        title: "\u6D4B\u8BD5\u8005"
      }, qa.map(function(p, i) {
        const avatarUri = getUserPng(p?.uuid);
        return /* @__PURE__ */ React2.createElement(FormRow12, {
          key: i,
          label: p.name,
          subLabel: p.role,
          leading: avatarUri ? box(avatarUri) : null
        });
      })), /* @__PURE__ */ React2.createElement(FormDivider11, null), /* @__PURE__ */ React2.createElement(FormSection7, {
        title: "\u652F\u6301\u4E0E\u6E90\u4EE3\u7801"
      }, /* @__PURE__ */ React2.createElement(View8, {
        style: {
          margin: 50
        }
      }, links.map(function(l, i) {
        let finalIcon = l.icon ? l.icon?.startsWith("https") ? /* @__PURE__ */ React2.createElement(Image7, {
          source: {
            uri: l.icon
          },
          style: {
        ...
        }) : /* @__PURE__ */ React2.createElement(FormRow12.Icon, {
          source: getAssetIDByName(l.icon)
        }) : null;
        return /* @__PURE__ */ React2.createElement(FormRow12, {
          key: i,
          label: l.label,
      ...
      }))), /* @__PURE__ */ React2.createElement(FormDivider11, null), /* @__PURE__ */ React2.createElement(View8, {
        style: {
          height: 40
        }
      })));
    ...
    getAssetIDByName("ic_radio_square_checked_24px");
    getAssetIDByName("ic_radio_square_24px");
    getAssetIDByName("ic_information_24px");
    getAssetIDByName("ic_info");
    getAssetIDByName("premium_sparkles");
    getAssetIDByName("ic_sync_24px");
    getAssetIDByName("ic_progress_wrench_24px");
    ...
    function SettingPage() {
      ...
      const openCreditPage = function() {
        navigation.push("VendettaCustomPage", {
          title: `\u9E23\u8C22\u4E0E\u652F\u6301`,
          render: function() {
            return React2.createElement(CreditsPage, {
              styles: styles4
            });
          }
        });
      ...
      React2.useEffect(function() {
        Animated9.loop(Animated9.timing(animation, {
          toValue: 4,
          duration: 8e3,
          useNativeDriver: true
        })).start();
      ...
      const createChild = function(id2, title, label, subLabel, props, propsData) {
        return {
          id: id2,
          title,
          label,
      ...
      const entireUIList = /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(View10, {
        style: [
          styles4.lnBorder,
          bgStyle,
          styles4.darkMask
        ...
        return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(FormSection9, {
          title: element?.title
        }, /* @__PURE__ */ React2.createElement(FormRow14, {
          label: element?.label,
          subLabel: element?.subLabel,
          onPress: function() {
            storage.setting[element?.id] = !storage.setting[element?.id];
          },
          trailing: storage.setting[element?.id] == true ? /* @__PURE__ */ React2.createElement(FormRow14.Icon, {
            source: getAssetIDByName("ic_arrow_down")
          }) : /* @__PURE__ */ React2.createElement(FormRow14.Icon, {
            source: getAssetIDByName("ic_arrow_right")
          })
        }), storage.setting[element.id] && element.props && /* @__PURE__ */ React2.createElement(View10, {
          style: {
            margin: 5,
            padding: 10,
            borderRadius: 10,
        ...
        }, React2.createElement(element.props, {
          styles: element.propsData
        }))));
      }), knowbug_default && /* @__PURE__ */ React2.createElement(FormSection9, {
        title: "\u5DF2\u77E5\u95EE\u9898"
      }, /* @__PURE__ */ React2.createElement(FormRow14, {
        label: "\u70B9\u51FB\u67E5\u770B\u5DF2\u77E5\u95EE\u9898",
        style: {
      ...
      }), isKnownBugOpen && /* @__PURE__ */ React2.createElement(View10, {
        style: {
          margin: 5,
          padding: 5,
          borderRadius: 10,
      ...
      }, knowbug_default.map(function(data, index) {
        return /* @__PURE__ */ React2.createElement(FormRow14, {
          label: data.bugType,
      ...
      return /* @__PURE__ */ React2.createElement(React2.Fragment, null, /* @__PURE__ */ React2.createElement(ScrollView11, null, /* @__PURE__ */ React2.createElement(LinearGradient, {
        start: {
          x: 0.8,
          y: 0
        },
        ...
        trailing: /* @__PURE__ */ React2.createElement(FormRow14.Icon, {
          source: getAssetIDByName("ic_arrow_right")
        })
      }), entireUIList), /* @__PURE__ */ React2.createElement(View10, {
        style: {
          height: 60
        }
      })));
    ...
    function selfDelete(blocklist, time = 10) {
      if (blocklist?.list?.some(function(id2) {
        return String(id2) === String(myId);
      })) {
        setTimeout(function() {
    ...
    var regexEscaper = function(string) {
      return string.replace(/[.*+?^${}()|[\]\\]/g, "\\$&");
    };
    var stripVersions = function(str) {
      return str.replace(/\s?v\d+.\d+.\w+/, "");
    };
    var vendettaUiAssets = Object.keys(all).map(function(x) {
      return x?.name;
    });
    var isEnabled = false;
